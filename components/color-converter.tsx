...
export function ColorConverter({ initialColor }: ColorConverterProps) {
  ...
  const [cmykColor, setCmykColor] = useState<CMYK>(initialColor || { c: 0, m: 0, y: 0, k: 0 });
  const [pantoneMatches, setPantoneMatches] = useState<PantoneMatch[]>([]);
  const [colorHistory, setColorHistory] = useState<CMYK[]>([]);
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Adjust the CMYK values to convert to other formats</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <Select value={outputFormat} onValueChange={(value) => setOutputFormat(value as ColorFormat)}>
            ...
            <CardContent>
              <ColorPreview cmyk={cmykColor} saveToHistory={saveToHistory} outputFormat={outputFormat} />
            </CardContent>
          </Card>
        </div>
          ...
          <Tabs defaultValue="matches">
            ...
            <TabsContent value="matches" className="mt-0">
              <Card>
                ...
                <CardContent>
                  <PantoneResults matches={pantoneMatches} onSelectPantone={(match) => {
            ...
            <TabsContent value="history" className="mt-0">
              <Card>
                ...
                <CardContent>
                  <ColorHistory colors={colorHistory} onSelectColor={loadFromHistory} />
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
